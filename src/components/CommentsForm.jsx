...
function CommentsForm({slug}) {
  ...
  return (
    <div className=" shadow-lg rounded-lg p-8 pb-12 mb-8 bg-gray-300  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40">
      ...
      <div className='mt-8'>
        <button type='button' onClick={handleCommentSubmission} className='transition duration-500 ease hover:bg-indigo-900 inline-block bg-pink-600 yext-lg rounded-full text-white px-8 py-3 cursor-pointer'>Post Comment</button>
